...
1. Restrict Content settings screen
2. Meta box on page / post edit screen for restricting content
3. Example of the message shown to users who do not have the required role to view the content, in this case a "Contributor" role
