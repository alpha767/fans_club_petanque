...
Restrict content easily to logged in users, users with a specific role or user capability, to it's author, Tickera or WooCommerce users and more!

== Description ==

The [Restrict plugin](https://restrict.io/?utm_source=wordpress.org&utm_medium=plugin-page&utm_campaign=main "Restricted Content for WordPress") makes it easy for you to control / protect access to the content of posts, pages and custom post types.
